...
- (void)dealloc
{
    [[NSNotificationCenter defaultCenter] removeObserver:self name:X6_Contactlist object:nil];
}
...
//        NSString *gsdm = [[userdefaluts objectForKey:X6_UserMessage] valueForKey:@"gsdm"];
//        if ([gsdm isEqualToString:[self.model.title substringToIndex:3]]) {
//            for (NSDictionary *dic in _datalist) {
//                NSString *phone = [self.model.title substringFromIndex:3];
