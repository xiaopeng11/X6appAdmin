...
//    [self initPlist];
    ...
    UIColor *commonLinkColor = Mycolor;
    ...
    if ([NSMutableParagraphStyle class]) {
        ...
        [mutableInactiveLinkAttributes setObject:[UIColor clearColor] forKey:(NSString *)kCTForegroundColorAttributeName];
        ...
        [mutableInactiveLinkAttributes setObject:(__bridge id)[[UIColor clearColor] CGColor] forKey:(NSString *)kCTForegroundColorAttributeName];
