...
- (void)viewDidLoad {
    ...
    if (_gwsArray.count * 60 < KScreenHeight - 64) {
        _gwsTableview = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, KScreenWidth, _gwsArray.count * 60) style:UITableViewStylePlain];
        _gwsTableview.scrollEnabled = NO;
    } else {
